...
<div class="container-fluid">
        <div class="block-header">
            <h2>DASHBOARD -> Doc Videos - Videos  </h2>
        </div>
...
<div class="modal fade" id="add" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <form id="submit" enctype="multipart/form-data" action="<?php echo base_url() ?>TestSeries/add_video_data" method="POST">
                                        ...
                                        <div class="row clearfix">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <select class="form-control show-tick" name="source_id" id="source_id" >
                                                    ...
                                                    if (isset($test_series) && !empty($test_series)){
                                                        foreach ($test_series as $row)
                                                        {?>
...
<div class="modal fade" id="edit" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <form id="submit_examsection" enctype="multipart/form-data" action="<?php echo base_url() ?>TestSeries/update_video_data" method="POST">
            <input type="hidden" name="source_type" value="test_series">
                                    ...
                                    <div class="demo-masked-input">
                                        <div class="row clearfix">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <select class="form-control show-tick" name="source_id" id="s_source_id" >
                                                    <option value="">Select Series</option>
                                                    <?php
                                                    $test_series = test_series();
                                                    if (isset($test_series) && !empty($test_series)){

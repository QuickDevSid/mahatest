<section class="content">
    <div class="container-fluid">
        <div class="block-header">
            <h2>DASHBOARD -> Marathi Sabd Sangrah - Category </h2>
        </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="card">
                    ...
                    <div class="body">
                        ...
                        <form id="categorysubmit" name="categorysubmit" enctype="multipart/form-data" action="<?php echo base_url() ?>MarathiSabd/marathi_sabd_category" method="POST">
                            <input type="hidden" name="source_type" value="marathi_sabd_category">

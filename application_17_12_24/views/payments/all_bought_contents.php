        ...
        <div class="row clearfix">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="card">
                    <div class="header">
                        <h2>
                            <strong>User Content List</strong>
                        </h2>
                        <hr>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            <select id="type" class="form-control" name="type">
                                                ...
                                                <option value="0" <?php if (isset($_GET['type']) && $_GET['type'] == "0") echo "selected"; ?>>Test Series</option>
                        ...
                        <hr>
                        <div style="overflow-x:scroll;">
                            <table id="user_content_data" class="table table-bordered table-striped table-hover dataTable js-exportable nowrap" width="100%">
                                <thead>
                                    <tr>

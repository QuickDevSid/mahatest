<section class="content">
    <div class="container-fluid">
        <div class="block-header">
            <h2>DASHBOARD -> English Vocabulary - Manage English Vocabulary </h2>
        </div>
        ...
        <div class="row clearfix">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="card">
                    <div class="header">
                        <h2>
                            Manage English Vocabulary
                        </h2>
                    </div>
                    <div class="body">

                        <form id="englishvocabularysubmit" name="englishvocabularysubmit" enctype="multipart/form-data" action="<?php echo base_url() ?>EnglishVocabulary/english_vocabulary_form" method="POST">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <div class="form-line">
                                                                <input type="text" name="title" id="title" class="form-control text" placeholder="Enter Title" value="<?php if (!empty($single)) {
                                                                                                                                                                            echo $single->english_vocabulary_title;
                                                                                                                                                                        } ?>">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <div class="form-line">
                                                                ...
                                                                <select name="category" id="category" class="form-control">
                                                                    ...
                                                                    <option value="" disabled selected>Select Vocabulary</option>

                                                                    <?php

                                                                    $category_data = $this->EnglishVocabulary_model->get_select_category();
                                                                    ...
                                                                    if (!empty($category_data)) {
                                                                        ...
                                                                        foreach ($category_data as $categorys) { ?>
                                                                            ...
                                                                            <option value="<?= $categorys->id ?>" <?= ($categorys->id == $selected_category) ? 'selected' : '' ?>>
                                                                                ...
                                                                                <?= $categorys->vocabulary_category_name ?>
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <div class="uploadOuter form-group">
                                                            <span class="dragBox">
                                                                ...
                                                                <input type="hidden" name="current_image" value="<?= isset($single) && !empty($single->english_vocabulary_image) ? htmlspecialchars($single->english_vocabulary_image) : '' ?>">
                                                            </span><br>
                                                            <?php if (!empty($single) && !empty($single->english_vocabulary_image)) : ?>
                                                                <img src="<?= base_url() ?>assets/uploads/english_vocabulary/images/<?= htmlspecialchars($single->english_vocabulary_image); ?>" alt="Image" style="width: 100px; height: auto;" />
                                                            <?php endif; ?>
                                                        ...
                                                        <div class="input-group">
                                                            <div class="form-line">
                                                                <textarea name="description" id="description" class="form-control text" placeholder="Enter Description" rows="5" cols="5"><?php if (!empty($single)) {
                                                                                                                                                                                                echo $single->english_vocabulary_description;
                                                                                                                                                                                            } ?></textarea>
                                                            </div>

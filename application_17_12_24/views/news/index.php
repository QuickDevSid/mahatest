...
<div class="modal fade" id="add_current_aff" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <form id="add_current_affair_form" enctype="multipart/form-data" action="<?php echo base_url() ?>news/addPost" method="POST">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="defaultModalLabel">Add New NEWS Post </h4>
                </div>
                                        ...
                                        <div class="media mb-4" id="d_comment">
                                            <div class="media mt-4">
                                                <div class="media-left">
                                                    <img class="d-flex mr-3 rounded-circle media-left" width="64" height="64" src="http://placehold.it/50x50" alt="">
                                                </div>

...
<div class="modal fade" id="add" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <form id="add_current_affair_form" enctype="multipart/form-data" action="<?php echo base_url() ?>Exam_subject/add_data_classes" method="POST">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="defaultModalLabel">Add New Class </h4>
                </div>
                                                        ...
                                                        <select class="form-control show-tick" name="subject" >
                                                            ...
                                                            if($examSectionArr){
                                                                foreach($examSectionArr as $r){
                                                                    ?>
                                                                    <option value="<?=$r->subject_id;?>"><?=$r->subject_name?> (<?=$r->section?>)</option>
                                                                    <?php
                                                                }
                                                            }
                                                            ?>
...
<div class="modal fade" id="edit" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <form id="add_current_affair_form" enctype="multipart/form-data" action="<?php echo base_url() ?>Exam_subject/update_data_classes" method="POST">
            <div class="modal-content">
                <div class="modal-header">
                                        ...
                                        <div class="row clearfix">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <div class="form-line">
                                                        <select class="form-control show-tick" name="subject" id="edit_subject" >
                                                            <option value="">Select Subject</option>
                                                            <?php
                                                            if($examSectionArr){
                                                                foreach($examSectionArr as $r){

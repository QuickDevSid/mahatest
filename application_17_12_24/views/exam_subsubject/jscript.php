...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $('#Exam_subsubject').addClass('active');
        getData();
    });
...
//Table data featching.
        var ur = "<?php echo base_url() ?>Exam_subsubject/fetch_data";
        //Exportable table
        $('#user_data').DataTable({
            dom: 'Bfrtip',
            destroy: true,
    ...
    function getDetailsEdit(getID) {
        ...
        $.ajax({
            type: "GET",
            url: "<?php echo base_url() ?>Exam_subsubject/subSubjectById/" + lid, // replace 'PHP-FILE.php with your php file
            dataType: "json",
            success: function (result) {
                if(result["id"])
                {
                    $('#edit_id').val(result["id"]);
                    $('#edit_subject_id').selectpicker('val',result["subject_id"]);
    ...
    function showConfirmMessage(getID) {
        ...
        if (lid === "") {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo base_url() ?>Exam_subsubject/deleteSubSubject",
                data: "id=" + lid,

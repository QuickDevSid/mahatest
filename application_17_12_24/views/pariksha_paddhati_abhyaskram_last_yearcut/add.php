...
<div class="modal fade" id="add" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <form id="cutoff_model" enctype="multipart/form-data" action="<?php echo base_url() ?>Pariksha_paddhati_abhyaskram_last_yearcut/add_data" method="POST">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="defaultModalLabel">Add New Pariksha_paddhati_abhyaskram_last_yearcut </h4>
                </div>

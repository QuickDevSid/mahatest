...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $('#Pariksha_paddhati_abhyaskram_wattage').addClass('active');
        $('#Pariksha_paddhati_abhyaskram_wattage').addClass('active');
...
//Table data featching.
        var ur = "<?php echo base_url() ?>Pariksha_paddhati_abhyaskram_wattage/fetch_data";
        //Exportable table
        $('#user_data').DataTable({
            dom: 'Bfrtip',
            destroy: true,
    ...
    function getDetailsEdit(getID) {
        ...
        $.ajax({
            type: "GET",
            url: "<?php echo base_url() ?>Pariksha_paddhati_abhyaskram_wattage/CategoryById/" + lid, // replace 'PHP-FILE.php with your php file
            dataType: "json",
    ...
    function showConfirmMessage(getID) {
        ...
        if (lid === "") {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo base_url() ?>Pariksha_paddhati_abhyaskram_wattage/deleteCategory",
                data: "id=" + lid,

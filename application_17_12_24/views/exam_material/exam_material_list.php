                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if ($cat->id == '9') { ?>
                                                    ...
                                                    <a href="<?= base_url('exam_material/examwise_pdf_list/' . $cat->id); ?>" class="btn btn-primary btn-sm" style="margin: 5px;">Examwise Pdf List</a>
                                                <?php } elseif ($cat->id == '8') { ?>
                                                    ...
                                                    <a href="<?= base_url('exam_material/subjectwise_test_list/' . $cat->id); ?>" class="btn btn-primary btn-sm" style="margin: 5px;">Subjectwise Test List</a>
                                                    <a href="<?= base_url('exam_material/add_examwise_test/' . $cat->id); ?>" class="btn btn-danger btn-sm" style="margin: 5px;">Examwise Test</a>
                                                    <a href="<?= base_url('exam_material/examwise_test_list/' . $cat->id); ?>" class="btn btn-primary btn-sm" style="margin: 5px;">Examwise Test List</a>
                                                <?php } else { ?>
                                                    <a href="<?= base_url('exam_material/add_subjectwise_pdf/' . $cat->id); ?>" class="btn btn-primary btn-sm" style="margin: 5px;">Subjectwise Pdf</a>
                                                    <a href="<?= base_url('exam_material/subjectwise_pdf_list/' . $cat->id); ?>" class="btn btn-primary btn-sm" style="margin: 5px;">Subjectwise Pdf List</a>
                                                    <a href="<?= base_url('exam_material/add_subjectwise_test/' . $cat->id); ?>" class="btn btn-danger btn-sm" style="margin: 5px;">Subjectwise Test</a>
                                                    <a href="<?= base_url('exam_material/subjectwise_test_list/' . $cat->id); ?>" class="btn btn-danger btn-sm" style="margin: 5px;">Subjectwise Test List</a>
                                                    <a href="<?= base_url('exam_material/add_examwise_pdf/' . $cat->id); ?>" class="btn btn-primary btn-sm" style="margin: 5px;">Examwise Pdf</a>
                                                    <a href="<?= base_url('exam_material/examwise_pdf_list/' . $cat->id); ?>" class="btn btn-primary btn-sm" style="margin: 5px;">Examwise Pdf List</a>
                                                    <a href="<?= base_url('exam_material/add_examwise_test/' . $cat->id); ?>" class="btn btn-danger btn-sm" style="margin: 5px;">Examwise Test</a>
                                                    <a href="<?= base_url('exam_material/examwise_test_list/' . $cat->id); ?>" class="btn btn-danger btn-sm" style="margin: 5px;">Examwise Test List</a>
                                                <?php } ?>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>

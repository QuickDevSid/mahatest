<section class="content">
    ...
    <div class="container-fluid">
        ...
        <div class="block-header">
            ...
            <h2>DASHBOARD -> Docs - Videos List</h2>
                                    ...
                                    <?php foreach ($category as $cat) : ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="<?= base_url('doc_videos/add_videos/' . $cat->id); ?>" class="btn btn-primary btn-sm">Edit</a>

                                                <a class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this record?');" href="<?= base_url('doc_videos/delete_video_list/' . $cat->id); ?>">

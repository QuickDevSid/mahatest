...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $('#Abhyas_sahitya_category').addClass('active');
        $('#Abhyas_sahitya_category').addClass('active');
    ...
    function getData() {
        ...
        var ur = "<?php echo base_url() ?>Abhyas_sahitya_category/fetch_abhyas_sahitya_category";
        //Exportable table
        $('#user_data').DataTable({
            dom: 'Bfrtip',
            destroy: true,
    ...
    function getcategoryDetailsEdit(getID) {
        ...
        $.ajax({
            type: "GET",
            url: "<?php echo base_url() ?>Abhyas_sahitya_category/CategoryById/" + lid, // replace 'PHP-FILE.php with your php file
            dataType: "json",
            success: function (result) {
                if(result["abhyas_sahitya_category_id"])
                {
                    $('#edit_id').val(result["abhyas_sahitya_category_id"]);
                    $('#edit_CategoryTitle').val(result["category_name"]);
    ...
    function showConfirmMessage(getID) {
        ...
        if (lid === "") {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo base_url() ?>Abhyas_sahitya_category/deleteCategory",
                data: "id=" + lid,

...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $('#Abhyas_sahitya').addClass('active');
...
//Table data featching.
        ...
        var ur = "<?php echo base_url() ?>Other_option/fetch_abhyas_sahitya";
        //Exportable table
        $('#user_data').DataTable({
            dom: 'Bfrtip',
            destroy: true,
    ...
    function getDetailsEdit(getID) {
        ...
        $.ajax({
            type: "GET",
            url: "<?php echo base_url() ?>Abhyas_sahitya/Abhyas_sahityaById/" + lid, // replace 'PHP-FILE.php with your php file
            dataType: "json",
            success: function (result) {
                if(result["abhyas_sahitya_id"])
                {
                    $('#edit_id').val(result["abhyas_sahitya_id"]);
                    $('#edit_AbhyasSahtyaTitle').val(result["abhyasSahtyaTitle"]);
                    ...
                    $('#edit_AbhyasSahityaCategoryId').selectpicker('val', result["abhyas_sahitya_category_id"]);
                    $('#edit_AbhyasSahitya_status').selectpicker('val', result["status"]);
    ...
    function showConfirmMessage(getID) {
        ...
        if (lid === "") {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo base_url() ?>Abhyas_sahitya/deleteAbhyas_sahitya",
                data: "id=" + lid,

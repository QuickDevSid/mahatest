...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $('#Test_series_pdfs').addClass('active');
...
//Table data featching.
        var ur = "<?php echo base_url() ?>Test_series_pdfs/fetch";
        //Exportable table
        $('#user_data').DataTable({
            dom: 'Bfrtip',
            destroy: true,
    ...
    function getDetailsEdit(getID)
    {
        ...
        $.ajax({
            type: "GET",
            url: "<?php echo base_url() ?>Test_series_pdfs/recordById/" + lid, // replace 'PHP-FILE.php with your php file
            dataType: "json",
    ...
    function deleteDetails(getID) {
        ...
        swal({
            title: "Are you sure?",
            text: "PDF will be deleted with ID : " + lid + "!",
            type: "warning",
    ...
    function showConfirmMessage(getID) {
        ...
        if (lid === "") {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo base_url() ?>Test_series_pdfs/deleteRecord",
                data: "id=" + lid,

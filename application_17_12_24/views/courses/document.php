...
<div class="container-fluid">
        <div class="block-header">
            <h2>DASHBOARD -> Courses - Documents  </h2>
        </div>
...
<div class="modal fade" id="add" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <form id="submit" enctype="multipart/form-data" action="<?php echo base_url() ?>Courses/add_doc_data" method="POST">
...
<div class="modal fade" id="edit" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <form id="submit_examsection" enctype="multipart/form-data" action="<?php echo base_url() ?>Courses/update_doc_data" method="POST">
            <input type="hidden" name="source_type" value="courses">
            <input type="hidden" name="id" id="edit_id" value="">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="defaultModalLabel">Update New Document </h4>
                </div>
                <div class="modal-body">
                    <!-- Masked Input -->
                    <div class="row clearfix">
                                    ...
                                    <div class="demo-masked-input">
                                        <div class="row clearfix">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <select class="form-control show-tick" name="status" id="s_status" >
                                                    <option value="Active">Active</option>
                                                    <option value="InActive">InActive</option>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <select class="form-control show-tick" name="can_download" id="s_can_download" >
                                                    <option value="Yes">Yes</option>
                                                    <option value="No">No</option>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <textarea class="form-control text" name="description" id="s_description" placeholder="Description" rows="5" cols="5" ></textarea>

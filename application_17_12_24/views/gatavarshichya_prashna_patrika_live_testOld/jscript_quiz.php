...
<script type="text/javascript">
    ...
    $(function () {
        $('#Gatavarshi_prashna_patrika_main').addClass('active');
        $('#Gatavarshi_prashna_patrika_main .menu-toggle').addClass('toggled');
        $('#Gatavarshi_prashna_patrika_main .ml-menu').css('display','block');

        $('#Gatavarshichya_prashna_patrika_live_test').addClass('active');
...
//Table data featching.
        var ur = "<?php echo base_url() ?>Gatavarshichya_prashna_patrika_live_test/fetch_data";
        //Exportable table
        $('#user_data').DataTable({
            dom: 'Bfrtip',
            destroy: true,
   ...
   $("#addquizform").submit(function (e) {
       ...
       $.ajax({
           type: "POST",
           url: "<?php echo base_url() ?>Gatavarshichya_prashna_patrika_live_test/addQuiz",
  ...
  function getquizDetails(getID) {
      ...
      $.ajax({
          type: "GET",
          url: "<?php echo base_url() ?>Gatavarshichya_prashna_patrika_live_test/QuizById/" + lid, // replace 'PHP-FILE.php with your php file
          dataType: "json",
  ...
  function getquizeEdit(getID) {
    ...
    $.ajax({
        type: "POST",
        url: "<?php echo base_url() ?>Gatavarshichya_prashna_patrika_live_test/Quizbyadd",
      ...
      function deletequizDetailsPerform(getID) {
         ...
         // alert(lid);
          ...
          if (lid === "") {
              ...
              $.ajax({
                  type: "DELETE",
                  url: "<?php echo base_url() ?>Daily_quiz_Api/deletequiz",
                  data: "id=" + lid,
                  success: function (data) {
                      $('#success_message').html(data);
                      console.log(data);
...
function addquizQuaDetails(getID) {
    var lid = getID.replace('Add_', '');
      $('#quiz_id').val(lid);
      var ur = "<?php echo base_url() ?>Gatavarshichya_prashna_patrika_live_test/fetch_qua_ans/" + lid;
      //Exportable table
    //  alert(lid);
      setTimeout(function() {
          //your datatable code
...
//alert(lid);
    ...
    {
      $.post("<?php echo base_url()?>Gatavarshichya_prashna_patrika_live_test/get_qtn_details",{id:id},function(res){
        var str=$.trim(res);
        // alert(str);
  ...
  $('#add_quiz_qua').submit(function(e){
           e.preventDefault();
              ...
              if(quiz_quation!="" && quiz_opt1!="" && quiz_opt2!="" && quiz_opt3!="" && quiz_opt4!="" && quiz_ans!="" && quiz_id!="")
                ...
                ({
                    ...
                    url: "<?php echo base_url() ?>Gatavarshichya_prashna_patrika_live_test/addquation",
                    type:"post",
     ...
     function showConfirmMessage(getID,uid) {
           ...
           swal({
               title: "Are you sure?",
               text: "Daily Quiz Question will be deleted with ID : " + lid + "!",
               type: "warning",
               showCancelButton: true,
               confirmButtonColor: "#DD6B55",
               confirmButtonText: "Yes, delete it!",
       ...
       function deletequaDetailsPerform(getID,uid) {
          ...
          // alert(lid);
           ...
           if (lid === "") {
               ...
               $.ajax({
                   type: "DELETE",
                   url: "<?php echo base_url() ?>Gatavarshichya_prashna_patrika_live_test/deletequizqua/"+lid+"",
                   data: "id=" + lid,
                   success: function (data) {
                       $('#success_message').html(data);
                       //console.log(data);

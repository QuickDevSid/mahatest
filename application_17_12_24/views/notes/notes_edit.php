...
<!-- Modal Dialogs ====================================================================================================================== -->
<!-- Default Size -->
<div class="modal fade" id="edit_notes" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <form id="add_masike_form" enctype="multipart/form-data" action="<?php echo base_url() ?>Notes/update_data" method="POST">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="defaultModalLabel">Edit Notes </h4>
                </div>
                                    ...
                                    <div class="demo-masked-input">
                                        <div class="row clearfix">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <div class="form-line">
                                                        <input type="text" name="edit_NotesTitle" id="edit_NotesTitle"
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <select class="form-control show-tick" name="edit_SelectedExamId[]" id="edit_SelectedExamId">
                                                        <?php
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <select class="form-control show-tick" name="edit_NotesSubjectId" id="edit_NotesSubjectId">
                                                        <?php
                                        ...
                                        <div class="row clearfix">
                                           ...
                                           <div class="col-md-4">
                                              ...
                                              <select class="form-control show-tick" name="edit_NotesStatus" id="edit_NotesStatus" >

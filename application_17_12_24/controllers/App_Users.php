    ...
    function fetch_user()
    {
        ...
        foreach ($fetch_data as $row) {
            ...
            $sub_array[] = '<a type="button" title="All Payments" name="Payments" href="'.base_url().'all_payments?user_id='.$row->id.'" id="payments_' . $row->id . '" class="btn bg-blue waves-effect btn-xs">
                            ...
                            <a type="button" title="All Contents" name="Payments" href="'.base_url().'all_bought_contents?user_id='.$row->id.'" id="payments_' . $row->id . '" class="btn bg-blue waves-effect btn-xs">

...
class Other_options_controller extends CI_Controller
{
    ...
    public function add_other_option()
    {
        ...
        if ($this->form_validation->run() === FALSE) {
            ...
            if ($res == "1") {
                ...
                // echo "inserted";
                // exit;
                if($this->input->post('other_option_category_id') == '4'){
                    redirect('other_option_new/other_option_list?syllabus');
                }else{
                    redirect('other_option_new/other_option_list');
                }
            } elseif ($res == "2") {
    ...
    public function other_option_list()
    {
        ...
        $this->load->view('other_option_new/other_options_list_script.php', $data);

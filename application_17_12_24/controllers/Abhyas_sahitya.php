...
//            print_r($fetch_data);
    ...
    public function addAbhyasSahitya()
    {
        ...
        if($AbhyasSahtyaTitle!="" && $AbhyasSahityaCategoryId!="" && $AbhyasSahitya_status!="" && $Description!="")
        {
            ...
            if(!$check)
            {
                $sql="INSERT INTO `abhyas_sahitya`(`abhyas_sahitya_category_id`, `title`, `description`, `image_url`, `pdf_url`, `status`, `created_on`) VALUES ('".$AbhyasSahityaCategoryId."', '".$AbhyasSahtyaTitle."', '".$Description."', '".$image."', '".$pdf."' ,'".$AbhyasSahitya_status."', '".date('Y-m-d H:i:s')."')";
//                echo $sql;

...
class Ebook_Category extends CI_Controller
{
    ...
    public function ebooks_sub_cat()
    {
        ...
        $this->load->view('templates/footer1', $data);
        $this->load->view('ebook_cat/ebook_sub_jscript.php', $data);
    }
    ...
    public function ebooks__cat_list()
    {
        ...
        $this->load->view('templates/menu', $data);
        $this->load->view('templates/footer1', $data);
        $this->load->view('ebook_cat/ebooks_cat_list_script.php', $data);
    }
    ...
    public function ebooks_sub_cat_list()
    {
        ...
        $this->load->view('templates/menu', $data);
        $this->load->view('templates/footer1', $data);
        $this->load->view('ebook_cat/ebook_sub_list_script.php', $data);
    }
    ...
    public function ebooks_setup_list()
    {
        ...
        $this->load->view('templates/menu', $data);
        $this->load->view('templates/footer1', $data);
        $this->load->view('ebook_cat/setup_list_jscript.php', $data);
    }

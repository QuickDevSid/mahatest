...
class Doc_Videos extends CI_Controller
{
    ...
    public function tests()
    {
        ...
        $this->load->view('templates/footer1', $data);
        $this->load->view('doc_videos/tests_script.php', $data);
    }
    ...
    public function add_document()
    {
        ...
        if ($this->form_validation->run() === FALSE) {
            $data['single'] = $this->DocsVideos_model->get_single_docs_n_videos(); //
            $this->load->view('doc_videos/add_document', $data);   //pending
            $this->load->view('templates/header1', $data);
            $this->load->view('templates/menu', $data);
            $this->load->view('templates/footer1', $data);
            // $this->load->view('courses/jscript.php', $data);
            $this->load->view('doc_videos/newscript.php', $data);  //pending
            ...
            $res = $this->DocsVideos_model->set_doc_n_videos_details($upload_image, $upload_pdf);
    ...
    {
        $data['category'] = $this->DocsVideos_model->get_single_document_list();
        // echo '<pre>';
        ...
        $this->load->view('templates/menu', $data);
        $this->load->view('templates/footer1', $data);
        $this->load->view('doc_videos/document_list_script.php', $data);
        // $this->load->view('courses/newjscript.php', $data);
    }

    public function delete_document_list($id)
    {
        $this->DocsVideos_model->delete_document_list($id);
    ...
    public function add_text()
    {
        ...
        $this->form_validation->set_rules('title', 'Title', 'required');
        if ($this->form_validation->run() === FALSE) {
            $data['single'] = $this->DocsVideos_model->get_single_text(); //
            ...
            $res = $this->DocsVideos_model->set_text_details($upload_image);
    ...
    {
        $data['category'] = $this->DocsVideos_model->get_single_text_list();
        // echo '<pre>';
        // print_r($data['category']);
        // exit();
        ...
        $this->load->view('templates/menu', $data);
        $this->load->view('templates/footer1', $data);
        $this->load->view('doc_videos/text_list_script.php', $data);
        // $this->load->view('courses/newjscript.php', $data);
    }

    public function delete_text_list($id)
    {
        $this->DocsVideos_model->delete_text_list($id);
        $this->session->set_flashdata('delete', 'Record deleted successfully');
    ...
    public function add_videos()
    {
        ...
        $this->form_validation->set_rules('title', 'Title', 'required');
        if ($this->form_validation->run() === FALSE) {
            $data['single'] = $this->DocsVideos_model->get_single_video();
            ...
            $res = $this->DocsVideos_model->set_videos($upload_image, $video_url);
    ...
    {
        $data['category'] = $this->DocsVideos_model->get_single_video_list();
        // echo '<pre>';
        // print_r($data['category']);
        // exit();
        ...
        $this->load->view('templates/menu', $data);
        $this->load->view('templates/footer1', $data);
        $this->load->view('doc_videos/videos_list_script.php', $data);
    }

    public function delete_video_list($id)
    {
        $this->DocsVideos_model->delete_video_list($id);
        $this->session->set_flashdata('delete', 'Record deleted successfully');

...
<div class="container-fluid">
        <div class="block-header">
            <h2><strong>Dashboard -> Docs & Videos -> Tests </strong></h2>
        </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="card">
                    <div class="header">
                        ...
                        <hr>
                        <form id="test_submit" enctype="multipart/form-data" action="<?php echo base_url() ?>doc_videos/add_docs_videos_tests" method="POST">
                                                ...
                                                <div class="col-md-8">
                                                    ...
                                                    <select class="form-control show-tick" name="test_id[]" id="test_id" multiple>
                                                        ...
                                                        if (!empty($tests)){
                                                            ...
                                                            {       
                                                                $is_already_set = $this->DocsVideos_model->get_is_test_already_set($row->id);
                                                        ?>

...
<div class="modal fade" id="add_youtube" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <form id="add_youtube_form" enctype="multipart/form-data" action="<?php echo base_url() ?>Videos/add_data_youtube" method="POST">
                                    ...
                                    <div class="demo-masked-input">
                                        <div class="row clearfix">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <div class="form-line">
                                                        <select class="form-control" id="exam_y" name="exams_y[]" multiple="">
                                                            <?php
                                        ...
                                        <div class="row clearfix">
                                            <div class="col-md-6">
                                                ...
                                                <select class="form-control show-tick" name="video_status_y" id="video_status_y">

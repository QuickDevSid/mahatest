...
//Table data featching.
        var ur = "<?php echo base_url() ?>Exam_subject/fetch_data_chapters";
        //Exportable table
        $('#user_data').DataTable({
            dom: 'Bfrtip',
            destroy: true,
    ...
    function getDetailsEdit(getID) {
        ...
        $.ajax({
            type: "GET",
            url: "<?php echo base_url() ?>Exam_subject/ChaptersById/" + lid, // replace 'PHP-FILE.php with your php file
            dataType: "json",
            success: function (result) {
                if(result["id"])
                {
                    ...
                    $('#edit_class_id').selectpicker('val',result["class_id"]);
                }
    ...
    function deleteDetails(getID) {
        ...
        swal({
            title: "Are you sure?",
            text: "Chapter will be deleted with ID : " + lid + "!",
            type: "warning",
    ...
    function showConfirmMessage(getID) {
        ...
        if (lid === "") {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo base_url() ?>Exam_subject/deleteChapter",
                data: "id=" + lid,
                success: function (data) {
                    ...
                    var str=$.trim(data);
                    if (str === "success") {
                        swal("Deleted!", "Your Chapter details has been deleted.", "success");
                        getData();
                    } else {

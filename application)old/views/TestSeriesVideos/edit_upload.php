...
<div class="modal fade" id="edit_upload" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <form id="edit_upload_form" enctype="multipart/form-data" action="<?php echo base_url() ?>Test_series_videos/update_data_upload" method="POST">
                                        ...
                                        <div class="row clearfix">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <div class="form-line">
                                                        <select class="form-control" id="edit_exam_u" name="edit_exams_u" onchange="return get_select_value_edit_upload(this)">
                                                            <?php
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <select class="form-control show-tick" name="edit_test_series_u" id="edit_test_series_u">
                                                        <?php
...
<script type="text/javascript">
    function get_select_value_edit_upload(val)
    {
        ...
        if(id>0)
        {
            $.ajax({
                ...
                success:function(response){
                    ...
                    $("#edit_test_series_u").empty();
                    $("#edit_test_series_u").append("<option value=''>Select Test Series </option>");
                    for( var i = 0; i<len; i++)
                    {
                        var id = response[i]['id'];
                        var name = response[i]['name'];
                        $("#edit_test_series_u").append("<option value='"+id+"'>"+name+"</option>");
                        $("#edit_test_series_u").selectpicker('refresh');
                    }

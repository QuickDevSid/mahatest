...
<section class="content">
    <div class="container-fluid">
        <div class="block-header">
            <h2>DASHBOARD ->  Push Notification to single user </h2>
        </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="card">
                    ...
                    <div class="body">
                    	 ...
                    	 <form id="add_current_affair_form" enctype="multipart/form-data" action="<?php echo base_url() ?>Push_notification/sent_to_single" method="POST">
  ...
  <div class="col-md-12">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <select class="form-control show-tick" name="email[]" id="email" multiple="">
                                                        <?php

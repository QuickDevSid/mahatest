...
<!-- Modal Dialogs ====================================================================================================================== -->
<!-- Default Size -->
<div class="modal fade" id="addquizqua" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <form id="add_quiz_qua" action="" method="POST">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="defaultModalLabel">Add Quiz Question<a href="#" id="question_model_show_button" class="btn btn-primary right" onclick="change_add_question_panel()">SHOW</a></h4>
                </div>
                                    ...
                                    <div class="demo-masked-input">
                                        <div class="row clearfix">
                                          <div id="addquizQuaDetails">
                                            <input type="hidden" name="quiz_id" id="quiz_id" class="form-control text"
                                          ...
                                          <div class="col-md-12">
                                            ...
                                            <div class="col-md-4">
                                             ...
                                             <select class="form-control show-tick" name="section" id="section">
                                              <?php
                                                $sql="SELECT * FROM `quiz_subject` WHERE status='Active' ";
                                                $sections=$this->common_model->executeArray($sql);
                                                if($sections)
                                                {
                                                  foreach ($sections as $section)
                                                  {
                                                      echo '<option value="'.$section->subject_id.'">'.$section->subject_name.'</option>';
                                                  }
                                                }
                                              ?>
                                             </select>

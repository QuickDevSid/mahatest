...
<div class="modal fade" id="editquiz" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <form id="getquizDetails" action="<?php echo base_url()?>Test_series_exam/update_exam" method="POST" >
                                            ...
                                            <div class="col-md-12">
                                             ...
                                             <div class="col-md-12">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <div class="form-line">
                                                      <select class="form-control" id="e_test_series" name="e_test_series">
                                                        <?php
    ...
    if(id>0)
    {
        $.ajax({
            ...
            success:function(response){
                ...
                $("#e_test_series").empty();
                $("#e_test_series").append("<option value=''>Select Category </option>");
                for( var i = 0; i<len; i++)
                {
                    var id = response[i]['id'];
                    var name = response[i]['name'];
                    $("#e_test_series").append("<option value='"+id+"'>"+name+"</option>");
                    $("#e_test_series").selectpicker('refresh');
                }
        ...
        $.ajax({
            ...
            success:function(response){
                ...
                for( var i = 0; i<len; i++)
                {
                    ...
                    if(id==edit_id)
                    {
                        $("#e_test_series").append("<option value='"+id+"' selected>"+name+"</option>");
                        $("#e_test_series").selectpicker('refresh');
                    }
                    else
                    {

...
<div class="modal fade" id="add" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <form id="getquizDetails" action="<?php echo base_url()?>Gatavarshichya_prashna_patrika_year_practice/add_data" method="POST" >
    ...
    if(id>0)
    {
        $.ajax({
            ...
            success:function(response){
                ...
                $("#question_paper_id").append("<option value=''>Select Exam </option>");
                for( var i = 0; i<len; i++)
                {

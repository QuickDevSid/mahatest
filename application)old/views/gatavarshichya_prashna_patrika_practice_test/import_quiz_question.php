...
<div class="modal fade" id="importQuestion" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <form id="import_quiz_qua" action="<?php echo base_url() ?>Gatavarshichya_prashna_patrika_practice_test/importQuestions" method="POST" enctype="multipart/form-data">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="defaultModalLabel">Import Quiz Question <a href="/assets/uploads/GatwarshichePrashnFormat.xlsx" class="btn btn-sm btn-primary right" download>Download Format</a></h4>
                </div>

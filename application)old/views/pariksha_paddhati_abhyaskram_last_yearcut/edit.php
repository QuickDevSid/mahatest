...
<div class="modal fade" id="edit" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <form id="add_current_affair_form" enctype="multipart/form-data" action="<?php echo base_url() ?>Pariksha_paddhati_abhyaskram_last_yearcut/update_data" method="POST">
                                        ...
                                        <div class="row clearfix">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <select class="form-control show-tick" name="ppa_id" id="edit_ppa_id">
                                                        <?php

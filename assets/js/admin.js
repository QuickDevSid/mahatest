...
function getAppSettingEdit() {

    // alert(lid);
    $.ajax({
        type: "GET",
        url: "Dashboard/getAppSettings" , // replace 'PHP-FILE.php with your php file
        dataType: "json",
        success: function (result) {

            $.each(result, function(index, item) {
                $("#" + item.key_label).val(item.key_value);
            });


            let newsrc = '';
            newsrc = 'AppAPI/banner-images/' + $("#setting_membership_image").val();

            $("#setting_e_img").attr("src", newsrc);
        },
        error: function () {
...
$('#editAppSetting').submit(function (e) {
    e.preventDefault();

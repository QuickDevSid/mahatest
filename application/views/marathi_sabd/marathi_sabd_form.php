<section class="content">
    <div class="container-fluid">
        <div class="block-header">
            <h2>DASHBOARD -> Marathi Sabd Sangrah - Manage Marathi Sabd Sangrah </h2>
        </div>
        ...
        <div class="row clearfix">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="card">
                    <div class="header">
                        <h2>
                            Manage Marathi Sabd Sangrah
                        </h2>
                    </div>
                    <div class="body">

                        <form id="marathisabdsubmit" name="marathisabdsubmit" enctype="multipart/form-data" action="<?php echo base_url() ?>MarathiSabd/marathi_sabd_form" method="POST">
                            <input type="hidden" name="source_type" value="marathi_sabd">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <div class="form-line">
                                                                <input type="text" name="title" id="title" class="form-control text" placeholder="Enter Title" value="<?php if (!empty($single)) {
                                                                                                                                                                            echo $single->marathi_sabd_title;
                                                                                                                                                                        } ?>">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <div class="form-line">
                                                                ...
                                                                <select name="category" id="category" class="form-control">
                                                                    ...
                                                                    $category_data = $this->MarathiSabd_model->get_select_category();
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <div class="uploadOuter form-group">
                                                            <span class="dragBox">
                                                                ...
                                                                <input type="hidden" name="current_image" value="<?= isset($single) && !empty($single->marathi_sabd_image) ? htmlspecialchars($single->marathi_sabd_image) : '' ?>">
                                                            </span><br>
                                                            <?php if (!empty($single) && !empty($single->marathi_sabd_image)) : ?>
                                                                <img src="<?= base_url() ?>assets/uploads/marathi_sabd/images/<?= htmlspecialchars($single->marathi_sabd_image); ?>" alt="Image" style="width: 100px; height: auto;" />
                                                            <?php endif; ?>
                                                        ...
                                                        <div class="input-group">
                                                            <div class="form-line">
                                                                <textarea name="description" id="description" class="form-control text" placeholder="Enter Description" rows="5" cols="5"><?php if (!empty($single)) {
                                                                                                                                                                                                echo $single->marathi_sabd_description;
                                                                                                                                                                                            } ?></textarea>
                                                            </div>

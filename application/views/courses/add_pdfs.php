        ...
        <div class="row clearfix">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="card">
                    ...
                    <div class="body">
                        <form id="test_submit" name="test_submit" enctype="multipart/form-data" action="<?php echo base_url() ?>Courses/add_pdfs" method="POST">
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <div class="form-group">
                                                            <select id="courses" class="form-control" name="source_id">
                                                                ...
                                                                $selected_course = !empty($single) ? $single->source_id : '';
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="uploadOuter form-group">
                                                            ...
                                                            <?php if (!empty($single) && !empty($single->pdf_url)): ?>
                                                                ...
                                                                <a href="<?= base_url() ?>assets/uploads/courses/pdfs/<?= htmlspecialchars($single->pdf_url); ?>" target="_blank">

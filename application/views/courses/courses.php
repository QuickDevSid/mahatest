<section class="content">
    <div class="container-fluid">
        <div class="block-header">
            <h2>DASHBOARD -> Courses - Manage Courses</h2>
        </div>
        ...
        <div class="row clearfix">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="card">
                    ...
                    <div class="body">
                        <form id="test_submit" name="test_submit" enctype="multipart/form-data" action="<?php echo base_url() ?>Courses/add_course_data" method="POST">
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <div class="uploadOuter form-group">
                                                            ...
                                                            <?php if (!empty($single) && !empty($single->banner_image)): ?>
                                                                <img src="<?= base_url() ?>assets/uploads/courses/images/<?= htmlspecialchars($single->banner_image); ?>" alt="Image" style="width: 100px; height: auto;" />
                                                            <?php endif; ?>

...
<div class="modal fade" id="edit_post" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
      <form class="form-horizontal" id="submit" action="<?php echo base_url()?>Pariksha_paddhati_abhyaskram/update_data" method="POST">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="defaultModalLabel">Edit Pariksha Paddhati Abhyaskram </h4>
                </div>
                                        ...
                                        <div class="row clearfix">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <div class="form-line">
                                                        <input type="text" name="Pariksha_paddhati_abhyaskramTitle" id="Pariksha_paddhati_abhyaskramTitle"
                                           ...
                                           <div class="col-md-4">
                                              ...
                                              <select class="form-control show-tick" name="Pariksha_paddhati_abhyaskramStatus" id="Pariksha_paddhati_abhyaskramStatus" >

...
//Table data featching.
        var ur = "<?php echo base_url() ?>Exam_subject/fetch_data";
        //Exportable table
        $('#user_data').DataTable({
            dom: 'Bfrtip',
            destroy: true,
    ...
    function getDetailsEdit(getID) {
        ...
        $.ajax({
            type: "GET",
            url: "<?php echo base_url() ?>Exam_subject/CategoryById/" + lid, // replace 'PHP-FILE.php with your php file
            dataType: "json",
    ...
    function showConfirmMessage(getID) {
        ...
        if (lid === "") {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo base_url() ?>Exam_subject/deleteCategory",
                data: "id=" + lid,

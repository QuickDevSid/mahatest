...
<script>
    $(document).ready(function() {
        ...
        $(function() {
            ...
            $('#membership_plan_admin').addClass('active');
            $('#membership_plan_admin .menu-toggle').addClass('toggled');
            $('#membership_plan_admin .ml-menu').css('display', 'block');

            $('#membership_plans_list').addClass('active');
            getData();
        });

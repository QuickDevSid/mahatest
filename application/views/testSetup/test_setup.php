<section class="content">
    <div class="container-fluid">
        <div class="block-header">
            <h2><strong>Dashboard -> Add Test </strong></h2>
        </div>
        <div class="row clearfix">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="card">
                    <div class="header">
                        <h2>
                            <strong>Add Test</strong><a style="float:right;" class="btn btn-info" href="<?=base_url();?>assets/Sample Questions Excel.xlsx" download>Download Sample Excel</a>
                        </h2>
                        <hr>
                                    ...
                                    <div class="body">
                                        <div class="demo-masked-input">
                                            ...
                                            <div class="row clearfix">
                                                ...
                                                <div class="col-md-4">
                                                    <b>Questions Excel File* <small>(.xlsx,.csv allowed)</small></b>
                                                    <div class="input-group">
                                                        <span class="input-group-addon">
                                                            <i class="material-icons">note</i>
                                                        </span>

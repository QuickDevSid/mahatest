...
<div class="container-fluid">
        <div class="block-header">
            <h2>DASHBOARD -> Doc Videos - Documents  </h2>
        </div>
...
<div class="modal fade" id="add" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <form id="submit" enctype="multipart/form-data" action="<?php echo base_url() ?>Doc_Videos/add_doc_data" method="POST">
...
<div class="modal fade" id="edit" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <form id="submit_examsection" enctype="multipart/form-data" action="<?php echo base_url() ?>Doc_Videos/update_doc_data" method="POST">
            <input type="hidden" name="source_type" value="doc_video">

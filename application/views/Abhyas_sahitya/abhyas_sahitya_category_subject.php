...
<section class="content">
    <div class="container-fluid">
        <div class="block-header">
            <h2>DASHBOARD -> Abhyas Sahitya Category Subject</h2>
        </div>
        ...
        <div class="row clearfix">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="card">
                    <div class="header">
                        <h2>
                          Abhyas Sahitya Category Subject
                          <button type="button" class="btn bg-teal waves-effect pull-right" data-toggle="modal"
                                     data-target="#add_abhyas_sahitya_category_subject">
                                 <i class="material-icons">person_add</i>
                                 <span>Add Abhyas Sahitya Category Subject</span>
                             </button>
                        </h2>

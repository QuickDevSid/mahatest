...
<!-- Modal Dialogs ====================================================================================================================== -->
<!-- Default Size -->
<div class="modal fade" id="add_abhyas_sahitya_category" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
      <form class="form-horizontal" id="submit" action="<?php echo base_url()?>Abhyas_sahitya_category/add_data" method="POST">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="defaultModalLabel">Add Abhyas Sahitya Category </h4>
                </div>
                                ...
                                <div class="body">
                                    <div class="demo-masked-input">
                                        <div class="row clearfix">
                                            ...
                                            <div class="col-md-4">
                                                <b>Abhyas Sahitya Category Title</b>

...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $('#Gatavarshi_prashna_patrika').addClass('active');
        $('#Gatavarshi_prashna_patrika').addClass('active');
...
//Table data featching.
        var ur = "<?php echo base_url() ?>Gatavarshi_prashna_patrika/fetch_data";
        //Exportable table
        $('#user_data').DataTable({
            dom: 'Bfrtip',
            destroy: true,
    ...
    function getDetailsEdit(getID) {
        ...
        $.ajax({
            type: "GET",
            url: "<?php echo base_url() ?>Gatavarshi_prashna_patrika/CategoryById/" + lid, // replace 'PHP-FILE.php with your php file
            dataType: "json",
    ...
    function showConfirmMessage(getID) {
        ...
        if (lid === "") {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo base_url() ?>Gatavarshi_prashna_patrika/deleteCategory",
                data: "id=" + lid,

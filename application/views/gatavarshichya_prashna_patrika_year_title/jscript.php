...
//Table data featching.
        var ur = "<?php echo base_url() ?>Gatavarshichya_prashna_patrika_year_title/fetch_data";
        //Exportable table
        $('#user_data').DataTable({
            dom: 'Bfrtip',
            destroy: true,
    ...
    $("#addquizform").submit(function (e) {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url() ?>Gatavarshichya_prashna_patrika_year_title/addQuiz",
    ...
    function getquizDetails(getID) {
        ...
        $.ajax({
            type: "GET",
            url: "<?php echo base_url() ?>Gatavarshichya_prashna_patrika_year_title/QuizById/" + lid, // replace 'PHP-FILE.php with your php file
            dataType: "json",
    ...
    $("#editquizform").submit(function (e) {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url() ?>Gatavarshichya_prashna_patrika_year_title/Quizbyadd",
    ...
    function deletequizDetailsPerform(getID) {
        ...
        if (lid === "") {
            ...
            $.ajax({
                type: "DELETE",
                url: "<?php echo base_url() ?>Gatavarshichya_prashna_patrika_year_title/deletequizqua/" + lid + "",
                data: "id=" + lid,
                success: function (data) {
                    $('#success_message').html(data);
                    console.log(data);

...
<div class="container-fluid">
        <div class="block-header">
            <h2>DASHBOARD -> Test Series - Pdf  </h2>
        </div>
...
<div class="modal fade" id="add" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <form id="submit" enctype="multipart/form-data" action="<?php echo base_url() ?>TestSeries/add_pdf_data" method="POST">
            ...
            <div class="modal-content">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <div class="form-line">
                                                        ...
                                                        <input type="number" name="time" id="time" class="form-control text" required min="0">
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <div class="form-line">
                                                        <input type="file" name="image" id="coursess"
                ...
                <div class="modal-footer">
                    <button type="submit" name="submit" id="submit" class="btn btn-link waves-effect">SAVE PDF
                    </button>
...
<div class="modal fade" id="edit" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <form id="submit_examsection" enctype="multipart/form-data" action="<?php echo base_url() ?>TestSeries/update_pdf_data" method="POST">
            <input type="hidden" name="source_type" value="test_series">
            <input type="hidden" name="id" id="edit_id" value="">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="defaultModalLabel">update New pdf </h4>
                </div>
                <div class="modal-body">
                    <!-- Masked Input -->
                    <div class="row clearfix">
                                        ...
                                        <div class="row clearfix">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <div class="form-line">
                                                        <!-- Input field for the time -->
                                                        <input type="number" name="time" id="edit_time" class="form-control text" required min="0">
                                                    </div>
                                                </div>
                                            </div>
...
<div class="modal fade" id="show" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <form >
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="defaultModalLabel">View Pdf Document</h4>
                </div>
                <div class="modal-body">
                    <!-- Masked Input -->
                    <div class="row clearfix">
                                        ...
                                        <div class="row clearfix">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <div class="form-line">
                                                        <!-- Input field for the time -->
                                                        <input type="number" name="time" id="s_time" class="form-control text" required min="0" disabled>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <!-- <div class="col-md-4">
                                                ...
                                                <span class="input-group-addon">
                                                    ...
                                                    <div class="form-line">
                                                        <input type="file" name="pdf" id="pdf"
                                                               class="form-control text" accept="application/pdf" disabled>
                                                    </div>
                                                </div>
                                            </div> -->
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <p>
                                                    ...
                                                    <textarea class="form-control text" name="description" id="s_description" disabled placeholder="Description" rows="5" cols="5" ></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<script>
    let type = 'Pdf';
    let id = 'test_series_pdf';
    let url = "<?php echo base_url() ?>get_test_series_details?type="+type;
</script>
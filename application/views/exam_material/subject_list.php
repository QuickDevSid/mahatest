<section class="content">
    <div class="container-fluid">
        <div class="block-header">
            <h2>DASHBOARD -> Exam Material - Subject List </h2>
        </div>
                                ...
                                <?php if (!empty($category)) : ?>
                                    ...
                                    <?php foreach ($category as $cat) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?= base_url('exam_material/add_subject/' . $cat->id); ?>" class="btn btn-primary btn-sm">Edit</a>
                                                <a class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this record?');" href="<?= base_url('exam_material/delete_subject_list/' . $cat->id); ?>">
                                                    Delete
                                                </a>
                                            </td>
                                        </tr>

<section class="content">
    <div class="container-fluid">
        <div class="block-header">
            <h2>DASHBOARD -> Exam Material - Subjectwise Test List</h2>
        </div>
        <div class="row clearfix">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="card">
                    <div class="header">
                        <h2>
                            <strong>Subjectwise Test List</strong>
                        </h2>
                        <hr>
                                ...
                                <?php if (!empty($category)) : ?>
                                    ...
                                    <?php foreach ($category as $cat) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?= base_url('exam_material/add_subjectwise_test/' . $cat->exam_material_id . '/' . $cat->id); ?>" class="btn btn-primary btn-sm">Edit</a>
                                                <a class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this record?');" href="<?= base_url('exam_material/delete_subjectwise_test/' . $cat->id); ?>">
                                                    Delete
                                                </a>
                                            </td>
                                        </tr>

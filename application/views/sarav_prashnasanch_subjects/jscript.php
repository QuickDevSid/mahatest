...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $('#Sarav_prashnasanch_subjects').addClass('active');
        $('#Sarav_prashnasanch_subjects').addClass('active');
...
//Table data featching.
        var ur = "<?php echo base_url() ?>Sarav_prashnasanch_subjects/fetch_data";
        //Exportable table
        $('#user_data').DataTable({
            dom: 'Bfrtip',
            destroy: true,
    ...
    function getDetailsEdit(getID) {
        ...
        $.ajax({
            type: "GET",
            url: "<?php echo base_url() ?>Sarav_prashnasanch_subjects/CategoryById/" + lid, // replace 'PHP-FILE.php with your php file
            dataType: "json",
    ...
    function showConfirmMessage(getID) {
        ...
        if (lid === "") {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo base_url() ?>Sarav_prashnasanch_subjects/deleteCategory",
                data: "id=" + lid,

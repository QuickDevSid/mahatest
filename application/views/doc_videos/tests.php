<section class="content">
    ...
    <div class="container-fluid">
        ...
        <div class="block-header">
            ...
            <h2>DASHBOARD -> Docs & Videos -> Tests </h2>
                ...
                <div class="card">
                    ...
                    <div class="header">
                        ...
                        <h2>
                            ...
                            <a href="<?= base_url(); ?>doc_videos/add-test" class="btn bg-teal waves-effect pull-right">
                                    ...
                                    ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="<?= base_url(); ?>doc_videos/delete-test/<?= $row->id; ?>" class="btn bg-red waves-effect">

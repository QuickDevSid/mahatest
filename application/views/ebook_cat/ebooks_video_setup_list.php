                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if ($cat->file_name != '') { ?>
                                                    <a href="<?= base_url() ?>assets/ebook_images/<?= $cat->file_name ?>" target="_blank">
                                                        View Video
                                                    </a>
                                                <?php } else { ?>
                                                    No PDF Available
                                            ...
                                            <td>
                                                ...
                                                <a href="<?= base_url('ebook_cat/ebooks_video_setup/' . $cat->ebook_id . '/' . $cat->id); ?>" class="btn btn-primary btn-sm">Edit</a>

                                                <a class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this record?');" href="<?= base_url('ebook_cat/delete_ebooks_video_setup/' . $cat->id); ?>">

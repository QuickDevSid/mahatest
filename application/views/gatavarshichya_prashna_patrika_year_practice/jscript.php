...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $('#Gatavarshi_prashna_patrika_year_practice').addClass('active');
        $('#Gatavarshi_prashna_patrika_year_practice').addClass('active');
...
//Table data featching.
        var ur = "<?php echo base_url() ?>Gatavarshichya_prashna_patrika_year_practice/fetch_data";
        //Exportable table
        $('#user_data').DataTable({
            dom: 'Bfrtip',
            destroy: true,
    ...
    function getDetailsEdit(getID) {
        ...
        $.ajax({
            type: "GET",
            url: "<?php echo base_url() ?>Gatavarshichya_prashna_patrika_year_practice/CategoryById/" + lid, // replace 'PHP-FILE.php with your php file
            dataType: "json",
    ...
    function deleteDetails(getID) {
        ...
        swal({
            title: "Are you sure?",
            text: "Subject will be deleted with ID : " + lid + "!",
            type: "warning",
    ...
    function showConfirmMessage(getID) {
        ...
        if (lid === "") {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo base_url() ?>Gatavarshichya_prashna_patrika_year_practice/deleteCategory",
                data: "id=" + lid,
                success: function (data) {
                    ...
                    var str=$.trim(data);
                    if (str === "success") {
                        swal("Deleted!", "Subject details has been deleted.", "success");
                        getData();
                    } else {

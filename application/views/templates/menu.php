    ...
    <aside id="leftsidebar" class="sidebar">
        ...
        <div class="menu">
            <ul class="list">
                ...
                <li id="app_user_management">
                    <a href="javascript:void(0);" class="menu-toggle"> <i class="material-icons">perm_media</i>
                        <span>App User Management</span> </a>
                    <ul class="ml-menu">
                        <li id="app_users">
                            <a href="<?= base_url('app_users') ?>"> <i class="material-icons">people</i>
                                <span>App Users List</span> </a>
                        </li>
                        <li id="all_payments">
                        ...
                        <li id="all_contents">
                            <a href="<?= base_url('all_bought_contents') ?>">
                                <i class="material-icons">description</i> <span>Content List</span> </a>
                        </li>
                        <li id="mobile_app_users">
                            <a href="<?= base_url('mobile_app_users') ?>"> <i class="material-icons">people</i>
                                <span>App User Devices Details</span> </a>
                        </li>
                    </ul>
                </li>
                <li id="membership_plan_admin">
                    <a href="javascript:void(0);" class="menu-toggle"> <i class="material-icons">perm_media</i>
                        <span>Membership Plans</span> </a>
                    <ul class="ml-menu">

                        <li id="add_membership_plans">
                ...
                <li id="current_affairs">
                    ...
                    <ul class="ml-menu">
                        ...
                        <li id="current_affairs_category">
                ...
                <li id="english_vocabulary">
                    ...
                    <ul class="ml-menu">
                        ...
                        <li id="english_vocabulary_form_list">
                        ...
                        <li id="english_vocabulary_category">
                            <a href="<?= base_url() ?>english_vocabulary/english_vocabulary_category">
                                <i class="material-icons">people</i> <span>Category</span> </a>
                        </li>
                        <li id="english_vocabulary_category_list">
                ...
                <li id="syllabus_options">
                    <a href="javascript:void(0);" class="menu-toggle"> <i class="material-icons">perm_media</i>
                        <span>Syllabus</span> </a>
                    <ul class="ml-menu">
                        <li id="add_syllabus">
                            <a href="<?= base_url('other_option_new/add_other_option?syllabus') ?>">
                                <i class="material-icons">description</i> <span>Add Syllabus</span> </a>
                        </li>
                        <li id="syllabus_list">
                            <a href="<?= base_url('other_option_new/other_option_list?syllabus') ?>">
                                <i class="material-icons">description</i> <span>Syllabus List</span> </a>
                        </li>
                    </ul>
                </li>

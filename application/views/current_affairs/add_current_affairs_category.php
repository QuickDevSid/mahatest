...
<section class="content">
    ...
    <div class="container-fluid">
        ...
        <div class="block-header">
            ...
            <h2><strong>Dashboard -> Current Affairs -> Category </strong></h2>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="header">
                        ...
                        <form id="categorysubmit" enctype="multipart/form-data" action="<?php echo base_url() ?>add_current_affairs_category" method="POST">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <div class="form-line">
                                                            ...
                                                            <input type="text" name="category_name" id="category_name" onkeyup="checkUniqueName()"
                                                                ...
                                                                value="<?php if(!empty($single)){ echo $single->category_name; }?>">
...
<script>    
    ...
    function checkUniqueName() {
        ...
        $.ajax({
            ...
            url: "<?php echo base_url() ?>Ajax_controller/check_unique_current_affair_category/",

...
if (
    ...
    $marks_query = "SELECT correct_answer_mark, wrong_answer_mark FROM test_series_exam_list WHERE test_series_exam_list_id = '$quiz_id'";
            ...
            if ( $result ) {
                ...
                foreach ( $data as $line ) {
                    ...
                    $result1 = $statment1->execute(
                        ...
                        $response [0]['message'] = 'Failed to save data';
                        echo json_encode( $response );
                    }
                } else {
                    $response [0]['status'] = 'Failed';

...
if ( isset( $_POST['test_series'] ) ) {
    ...
    $query = "SELECT * FROM test_series_questions WHERE `test_series` = '$test_series' AND status = 'Active' ORDER BY test_series_questions.test_series_questions_id ";
    ...
    FROM test_series_questions r, quiz_subject s WHERE r.test_series = '$test_series'
...
foreach ($result1 as $row) {
    ...
    WHERE test_series = '$test_series' AND subject_id = '$sid' AND status = 'Active'";

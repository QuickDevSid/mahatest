...
if (
    isset( $_POST['question_papers_id'] ) ) {
        ...
        if (!empty( $question_papers_id ) ) {

    //Get questions details for pagination.
    $marks_query = "SELECT correct_answer_mark, wrong_answer_mark FROM gatavarshichya_prashna_patrika_year_title_practice WHERE question_papers_id = '$question_papers_id'";
    ...
    $total_marks = ($correct_answer_mark * $correct_answer) - ($wrong_answer_mark * $wrong_answer);
                ...
                $query = "INSERT INTO `previous_exam_result`(
						`question_papers_id`,
						`login_id`,
						`correct_answer`,
						`wrong_answer`,
                ...
                $result = $statment->execute(
                    ...
                    if ( $result ) {
                        ...
                        foreach ( $data as $line ) {
                            ...
                            $query1 = "INSERT INTO `previous_exam_result_details`(

...
if ( isset( $_POST['quiz_result_id'] ) ) {
    ...
    $query = "SELECT * FROM 
                    sarav_prashnasanch_result_details a, sarav_prashnasanch_result b, sarav_prashnasanch_question c 
                    WHERE a.sarav_prashnasanch_result_id = b.sarav_prashnasanch_result_id 
                    AND a.question = c.question 
                    AND a.sarav_prashnasanch_result_id = $quiz_result_id
                    GROUP BY a.id";
...
//Get questions details for pagination.
    $id_query = "SELECT quiz_id FROM sarav_prashnasanch_result WHERE sarav_prashnasanch_result_id = '$quiz_result_id'";
    ...
    FROM sarav_prashnasanch_question r, quiz_subject s WHERE r.sarav_prasnasanch_id = '$quiz_id' 
    ...
    foreach ($result1 as $row) {
        ...
        WHERE sarav_prasnasanch_id = '$quiz_id' AND subject_id = '$sid' AND status = 'Active'";

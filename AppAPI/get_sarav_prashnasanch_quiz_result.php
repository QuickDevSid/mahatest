...
if (
    ...
    $marks_query = "SELECT correct_answer_mark, wrong_answer_mark FROM sarav_prasnasanch WHERE sarav_prasnasanch_id  = '$quiz_id'";
    ...
    $total_marks = ($correct_answer_mark * $correct_answer) - ($wrong_answer_mark * $wrong_answer);
                ...
                $query = "INSERT INTO `sarav_prashnasanch_result`(
						`quiz_id`,
						`login_id`,
						`correct_answer`,
						`wrong_answer`,
                ...
                $result = $statment->execute(
                    ...
                    if ( $result ) {
                        ...
                        foreach ( $data as $line ) {
                            ...
                            $query1 = "INSERT INTO `sarav_prashnasanch_result_details`(
                            ...
                            $result1 = $statment1->execute(
                                array(
                                    ':sarav_prashnasanch_result_id' => $id,

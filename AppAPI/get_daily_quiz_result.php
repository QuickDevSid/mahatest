...
if ( isset( $_POST['quiz_result_id'] ) ) {
    ...
    $query = "SELECT * FROM 
quiz_result_detail a, quiz_result b, daily_quiz_questions c 
WHERE a.quiz_result_id = b.quiz_result_id 
AND a.question = c.question 
AND a.quiz_result_id = $quiz_result_id
GROUP BY a.id";
    ...
    $id_query = "SELECT quiz_id FROM quiz_result WHERE quiz_result_id = '$quiz_result_id'";

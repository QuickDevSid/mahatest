...
if ( isset( $_POST['question_paper_year'] ) ) {
    ...
    $query ="SELECT * FROM gatavarshichya_prashna_patrika_year_title WHERE question_paper_year = '$question_paper_year'";
...
$quiz = array();
   ...
   foreach ($result as $row) {
    ...
    $quiz['updated_on'] = $row['updated_on'];
        ...
        $query_question = "SELECT * FROM previous_exam_live_test_result WHERE question_papers_id = '$quiz_id' AND login_id = '$login_id' ORDER BY previous_exam_live_test_result_id DESC LIMIT 1";
    ...
    $quiz['quiz_result_id'] = $result_questions['previous_exam_live_test_result_id'];
